...
const PatternsLink = () => {
  return (
    <ExternalLink href="https://patterns.vektor-inc.co.jp/">VK パターンライブラリ</ExternalLink>
  );
};
...
domReady(() => {
  ...
  const buttonRender = (() => {
    const headerToolbar = document.querySelector('.edit-post-header-toolbar') || document.querySelector('.edit-site-header__toolbar')
    if (!headerToolbar) {
      return
    }
